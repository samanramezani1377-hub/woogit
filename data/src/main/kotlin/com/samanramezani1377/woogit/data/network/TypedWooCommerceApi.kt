...
@Serializable data class WooVariationTypedDto(val id:Long,val sku:String?=null,val price:String?=null,val regular_price:String?=null,val sale_price:String?=null,val stock_quantity:Double?=null,val stock_status:String="instock",val date_modified_gmt:String?=null,val attributes:List<WooProductAttributeDto> = emptyList())
