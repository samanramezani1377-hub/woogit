...
class TypedWooCommerceApi(private val raw:WooCommerceApi){
 private fun <T> decode(r:ApiResponse,d:(String)->T):Result<T>=if(r.statusCode in 200..299)runCatching{d(r.body)}else Result.failure(HttpApiException(r.statusCode,r.body))
