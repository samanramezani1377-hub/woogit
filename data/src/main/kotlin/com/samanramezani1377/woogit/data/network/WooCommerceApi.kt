...
class WooCommerceApi(private val backend: BackendClient, private val storeId: String, private val credentials: CredentialPair) {
    ...
    suspend fun uploadMedia(b:String,fileName:String,bytes:ByteArray,mediaType:String)=backend.forwardBinary(storeId,"/wp-json/wp/v2/media","POST",credentials,emptyMap(),bytes,mediaType,fileName)
