...
class AppComposition(context:Context){
 ...
 private val getConflictsFn:suspend(StoreId)->com.samanramezani1377.woogit.core.domain.error.CoreResult<List<com.samanramezani1377.woogit.core.domain.model.Conflict>>={store->getConflicts(store)}
 private val resolveConflictFn:suspend(StoreId,com.samanramezani1377.woogit.core.domain.entity.EntityId,com.samanramezani1377.woogit.core.domain.model.ConflictResolution)->com.samanramezani1377.woogit.core.domain.error.CoreResult<Unit>={store,id,resolution->resolveConflict(store,id,resolution)}
