...
class AppComposition(context:Context){
 ...
 private val executor=WooCommerceOperationExecutor(db,provider,orderLocal,productLocal);private val syncEngine=SyncEngine(db,executor);private val syncRepository=SyncRepositoryImpl(db,syncEngine,pending)
