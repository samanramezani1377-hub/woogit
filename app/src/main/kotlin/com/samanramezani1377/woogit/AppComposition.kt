...
class AppComposition(context:Context){
 ...
 private val executor=WooCommerceOperationExecutor(db,provider,orderLocal,productLocal,variationLocal);private val syncEngine=SyncEngine(db,executor);private val syncRepository=SyncRepositoryImpl(db,syncEngine,pending)
