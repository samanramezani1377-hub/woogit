...
class AppComposition(context:Context){
 ...
 val v1Presentation=V1PresentationDependencies(getStore,connectStore,disconnectStore,getOrders,getOrder,updateOrder,addOrderNote,getProducts,getProduct,createProduct,updateProduct,deleteProduct,getVariations,getVariation,createVariation,updateVariation,deleteVariation,getAttributes,getAttribute,createAttribute,updateAttribute,deleteAttribute,getTerms,getTerm,createTerm,updateTerm,deleteTerm,getConnectionState,getSyncState,getPending,getConflicts,resolveConflict,syncPending,prefs.getString("active_store_id",null),::rememberStore,::forgetStore)
