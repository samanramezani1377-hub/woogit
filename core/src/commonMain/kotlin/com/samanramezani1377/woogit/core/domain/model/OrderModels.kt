...
data class Order(val id: EntityId, val status: OrderStatus, val customer: Customer?, val billing: Address?, val shipping: Address?, val payment: Payment?, val shippingLines: List<ShippingLine>, val discounts: List<Discount>, val notes: List<OrderNote>, val items: List<OrderItem>, val modifiedAt: EntityTimestamp?)
