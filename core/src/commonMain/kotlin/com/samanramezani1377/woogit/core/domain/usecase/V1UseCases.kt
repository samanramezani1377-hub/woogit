...
class DownloadMediaUseCase(private val r: MediaRepository) : DownloadMedia { override suspend fun invoke(storeId: StoreId, image: ProductImage) = r.download(storeId, image) }
