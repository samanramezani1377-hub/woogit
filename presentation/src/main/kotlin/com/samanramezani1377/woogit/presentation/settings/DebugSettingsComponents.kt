...
internal fun DashboardSalesDebugPanel(clipboard: ClipboardManager) {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        ...
        GlassText("جمع سفارش‌های تکمیل‌شده: ${snapshot.completedOrderSum}")
        GlassText("SalesSummary.netSales: ${snapshot.reportedNetSales ?: "null"}")
        GlassText("منبع درآمد: ${snapshot.revenueSource}")
