...
// All .woogit ZIP writes are routed through the active layout kernel.
// This keeps Export physically bound to the same contract Import validates.
internal fun writeTransferEntry(zip:ZipOutputStream,path:String,bytes:ByteArray){ProductTransferFormat.writeEntry(zip,path,bytes)}
