...
@Serializable data class ProductTransferManifest(val format:String,val version:Int,val source:String,val exportedAt:String,val products:Int,val images:Int)
