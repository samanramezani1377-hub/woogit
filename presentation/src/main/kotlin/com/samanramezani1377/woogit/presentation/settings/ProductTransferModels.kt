...
@Serializable
data class ProductTransferManifest(val format:String="woogit-products",val version:Int=1,val source:String,val exportedAt:String,val products:Int,val images:Int)

@Serializable
data class ProductTransferPackage(val manifest:ProductTransferManifest,val products:List<TransferProduct>,val globalAttributes:List<TransferGlobalAttribute> = emptyList())
