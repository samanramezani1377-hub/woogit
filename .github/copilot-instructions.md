...
Any AI agent operating on this repository MUST use both required engineering methodologies:
...
UNLAZY: continue through implementation, build/test, review, and verification until the requested acceptance criteria are actually satisfied or a genuine external blocker prevents progress. Never fake, weaken, skip, or bypass checks to obtain green results.
